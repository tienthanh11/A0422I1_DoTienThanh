...
public class CustomerServiceImpl implements CustomerService {
    ...
    public List<Customer> search(String keyword) {
        Iterable<Customer> searchResult = customerRepository.findAllByNameContainsOrEmailContainsOrAddressContains(keyword, keyword, keyword);
    ...
    public List<Customer> save(List<Customer> customers) {
        Iterable<Customer> updateCustomers = customerRepository.saveAll(customers);
        return streamAll(updateCustomers).collect(Collectors.toList());
    }
