package com.codegym.demo_aop.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.codegym.demo_aop.service.BookServiceImpl.*(..))")
    ...
    @After("execution(* com.codegym.demo_aop.service.BookServiceImpl.getList())")
    ...
    // point cut refer method bookservice => "execution(* com.codegym.demo.service.BookService.*(..))"
    ...
    @AfterReturning("execution(* com.codegym.demo_aop.service.BookServiceImpl.fi*(..))")
