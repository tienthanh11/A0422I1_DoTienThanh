...
<div>
    <center>
        <br>
        <h1 class="font-text-footer" style="color: #cbbe73">Edit Product</h1>
        <c:if test="${mess != null}">
        ...
        <div class="container">
            <form action="/product?action=edit&id=${product.id}" method="post">
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="name" class="form-control me-2" value="${product.name}" required>
                </div>

                <div class="input-group mb-3">
                    <span class="input-group-text">Price</span>
                    <input type="text" name="price" class="form-control me-2" value="${product.price}" required>
                </div>

                <div class="input-group mb-3">
                    <span class="input-group-text">Quantity</span>
                    <input type="number" name="quantity" class="form-control me-2" value="${product.quantity}" required>
                </div>

                <div class="input-group mb-3">
                    <span class="input-group-text">Color</span>
                    <input type="text" name="color" class="form-control me-2" value="${product.color}" required>
                </div>

                <div class="input-group mb-3">
                    <span class="input-group-text">Describe</span>
                    <input type="text" name="describe" class="form-control me-2" value="${product.describe}" required>
                </div>
